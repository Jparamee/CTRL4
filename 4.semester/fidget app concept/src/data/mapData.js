  ...
  "natural-history": {
    ...
    floors: [
      ...
      { id: 'floor0', title: 'Level 0 - Entrance & Cafe', user_loc: {x: 80, y: 160}, rooms: [
        ...
        { id: 'mind_lab', label: 'Mind Lab Auditorium', x: 150, y: 105, w: 150, h: 75, shapeClass: 'room-theatre', busy: 'med', trigger_warnings: ['Loud audio presentations'], population: 28, doors: [{id: 'd0_mind_in', x: 149, y: 130, w: 2, h: 20}] }
      ]},
  ...
  "aros": {
    ...
    floors: [
      { id: 'aros_f1', title: 'Level 10', user_loc: {x: 160, y: 50}, rooms: [
        { id: 'rainbow', label: 'Your rainbow panorama', x: 20, y: 20, w: 280, h: 60, shapeClass: 'room-main-shape', busy: 'high', trigger_warnings: ['Bright colors', 'Sunlight exposure'], population: 85, doors: [{id: 'r_d1', x: 150, y: 79, w: 20, h: 2}] },
