  ...
  "aros": {
    ...
    floors: [
      { id: 'aros_f1', title: 'Level 10', user_loc: {x: 160, y: 50}, rooms: [
        { id: 'rainbow', label: 'Your rainbow panorama', x: 20, y: 20, w: 280, h: 60, shapeClass: 'room-main-shape', busy: 'high', trigger_warnings: ['Bright colors'], population: 85, doors: [{id: 'r_d1', x: 150, y: 78, w: 20, h: 2}] },
        { id: 'aros_cafe', label: 'Sunset Cafe', x: 100, y: 100, w: 120, h: 80, shapeClass: 'room-alt', busy: 'med', trigger_warnings: [], population: 20, doors: [{id: 'c_d1', x: 150, y: 100, w: 20, h: 2}] }
      ]}
    ]
  }
}